...
def calculate_demographic_data(print_data=True):
  ...
  lower_education_rich = round(
    lower_education.loc[lower_education["salary"] == ">50K", "salary"].count()
  ...
  rich_percentage = round(
    num_min_workers.loc[num_min_workers["salary"] == ">50K", "salary"].count()
  ...
  highest_earning_country_percentage = round(
    (df.loc[
      (df["salary"] == ">50K") &
      (df["native-country"] == highest_earning_country), "salary"].count() /
     df.loc[df["native-country"] == highest_earning_country, "salary"].count())
    * 100, 1)
